package com.example.cinemaxv3.domain.paging.mediators
        ...
        try {
            ...
            db.withTransaction {
                ...
                if(upComingMovies != null){
                    db.getUpComingMoviesDao().insertUpComingMovies(upComingMovies.onEachIndexed { _, upComingMovies -> upComingMovies.page = page })
                }
            }
