...
public final class ItemReviewsBinding implements ViewBinding {
  ...
  private ItemReviewsBinding(@NonNull CardView rootView, @NonNull CircleImageView authorAvatar,
  ...
  public static ItemReviewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReviewsBinding((CardView) rootView, authorAvatar, authorName, authorUserName,
