...
public final class FragmentMovieBinding implements ViewBinding {
  ...
  private FragmentMovieBinding(@NonNull ScrollView rootView, @NonNull Button btnTrailer,
      @NonNull CardView cardView, @NonNull TextView internet, @NonNull ImageView popMov,
  ...
  public static FragmentMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.internet;
      TextView internet = ViewBindings.findChildViewById(rootView, id);
      if (internet == null) {
        break missingId;
      }
      ...
      return new FragmentMovieBinding((ScrollView) rootView, btnTrailer, cardView, internet, popMov,
          popularMoviesRecyclerview, textView2, textView3, textView4, topRatedMoviesRecyclerview,
          upComingMoviesRecyclerview, vote);
    }
