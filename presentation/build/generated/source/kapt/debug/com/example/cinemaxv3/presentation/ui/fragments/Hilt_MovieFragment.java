 ...
 */
public abstract class Hilt_MovieFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MovieFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MovieFragment_GeneratedInjector) this.generatedComponent()).injectMovieFragment(UnsafeCasts.<MovieFragment>unsafeCast(this));
    }
  }
