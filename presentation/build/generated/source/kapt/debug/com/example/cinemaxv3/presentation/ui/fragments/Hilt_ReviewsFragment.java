 ...
 */
public abstract class Hilt_ReviewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReviewsFragment() {
    super();
  }

  Hilt_ReviewsFragment(int contentLayoutId) {
