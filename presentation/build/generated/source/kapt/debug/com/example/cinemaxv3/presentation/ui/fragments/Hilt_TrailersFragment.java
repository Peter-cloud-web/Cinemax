 ...
 */
public abstract class Hilt_TrailersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TrailersFragment() {
    super();
  }

  Hilt_TrailersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrailersFragment_GeneratedInjector) this.generatedComponent()).injectTrailersFragment(UnsafeCasts.<TrailersFragment>unsafeCast(this));
    }
  }
