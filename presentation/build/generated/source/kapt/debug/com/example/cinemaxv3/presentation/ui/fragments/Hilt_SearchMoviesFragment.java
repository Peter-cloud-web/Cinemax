 ...
 */
public abstract class Hilt_SearchMoviesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchMoviesFragment() {
    super();
  }

  Hilt_SearchMoviesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchMoviesFragment_GeneratedInjector) this.generatedComponent()).injectSearchMoviesFragment(UnsafeCasts.<SearchMoviesFragment>unsafeCast(this));
    }
  }
