 ...
 */
public abstract class Hilt_FavouriteMovieFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteMovieFragment() {
    super();
  }

  Hilt_FavouriteMovieFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteMovieFragment_GeneratedInjector) this.generatedComponent()).injectFavouriteMovieFragment(UnsafeCasts.<FavouriteMovieFragment>unsafeCast(this));
    }
  }
