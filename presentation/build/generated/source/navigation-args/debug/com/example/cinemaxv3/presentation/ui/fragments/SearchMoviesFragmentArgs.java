...
public class SearchMoviesFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private SearchMoviesFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private SearchMoviesFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static SearchMoviesFragmentArgs fromBundle(@NonNull Bundle bundle) {
    SearchMoviesFragmentArgs __result = new SearchMoviesFragmentArgs();
    bundle.setClassLoader(SearchMoviesFragmentArgs.class.getClassLoader());
    ...
    if (bundle.containsKey("poster_path")) {
      String posterPath;
      posterPath = bundle.getString("poster_path");
      if (posterPath == null) {
        throw new IllegalArgumentException("Argument \"poster_path\" is marked as non-null but was passed a null value.");
      }
      __result.arguments.put("poster_path", posterPath);
    } else {
      throw new IllegalArgumentException("Required argument \"poster_path\" is missing and does not have an android:defaultValue");
    }
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static SearchMoviesFragmentArgs fromSavedStateHandle(
    ...
    if (savedStateHandle.contains("poster_path")) {
      String posterPath;
      posterPath = savedStateHandle.get("poster_path");
      if (posterPath == null) {
        throw new IllegalArgumentException("Argument \"poster_path\" is marked as non-null but was passed a null value.");
      }
      __result.arguments.put("poster_path", posterPath);
  ...
  public String getPosterPath() {
    return (String) arguments.get("poster_path");
  }
  ...
  public Bundle toBundle() {
    ...
    if (arguments.containsKey("poster_path")) {
      String posterPath = (String) arguments.get("poster_path");
      __result.putString("poster_path", posterPath);
    }
  ...
  public SavedStateHandle toSavedStateHandle() {
    ...
    if (arguments.containsKey("poster_path")) {
      String posterPath = (String) arguments.get("poster_path");
      __result.set("poster_path", posterPath);
    }
    if (arguments.containsKey("backdrop")) {
      String backdrop = (String) arguments.get("backdrop");
  ...
  public boolean equals(Object object) {
    ...
    SearchMoviesFragmentArgs that = (SearchMoviesFragmentArgs) object;
    ...
    if (arguments.containsKey("poster_path") != that.arguments.containsKey("poster_path")) {
      return false;
    }
  ...
  public String toString() {
    return "SearchMoviesFragmentArgs{"
        + "image=" + getImage()
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull SearchMoviesFragmentArgs original) {
      this.arguments.putAll(original.arguments);
    }

    @SuppressWarnings("unchecked")
    public Builder(@NonNull String image, @NonNull String posterPath, @NonNull String backdrop,
        @NonNull String title, @NonNull String description, float rating, int id) {
      if (image == null) {
        throw new IllegalArgumentException("Argument \"image\" is marked as non-null but was passed a null value.");
      }
      ...
      this.arguments.put("poster_path", posterPath);
      if (backdrop == null) {
        throw new IllegalArgumentException("Argument \"backdrop\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    public SearchMoviesFragmentArgs build() {
      SearchMoviesFragmentArgs result = new SearchMoviesFragmentArgs(arguments);
      return result;
    }
