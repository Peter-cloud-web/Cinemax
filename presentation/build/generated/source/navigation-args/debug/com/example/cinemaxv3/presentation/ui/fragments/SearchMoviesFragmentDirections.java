...
public class SearchMoviesFragmentDirections {
  private SearchMoviesFragmentDirections() {
  }

  @NonNull
  public static ActionSearchMoviesFragmentToMovieDetailsFragment actionSearchMoviesFragmentToMovieDetailsFragment(
      @NonNull String image, @NonNull String backdrop, @NonNull String title,
      @NonNull String description, float rating, int id) {
    return new ActionSearchMoviesFragmentToMovieDetailsFragment(image, backdrop, title, description, rating, id);
  }

  public static class ActionSearchMoviesFragmentToMovieDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionSearchMoviesFragmentToMovieDetailsFragment(@NonNull String image,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setImage(@NonNull String image) {
      if (image == null) {
        throw new IllegalArgumentException("Argument \"image\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("image", image);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setBackdrop(@NonNull String backdrop) {
      if (backdrop == null) {
        throw new IllegalArgumentException("Argument \"backdrop\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("backdrop", backdrop);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setTitle(@NonNull String title) {
      if (title == null) {
        throw new IllegalArgumentException("Argument \"title\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("title", title);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setDescription(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setRating(float rating) {
      this.arguments.put("rating", rating);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMoviesFragmentToMovieDetailsFragment setId(int id) {
      this.arguments.put("id", id);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_searchMoviesFragment_to_movieDetailsFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSearchMoviesFragmentToMovieDetailsFragment that = (ActionSearchMoviesFragmentToMovieDetailsFragment) object;
    ...
    public String toString() {
      return "ActionSearchMoviesFragmentToMovieDetailsFragment(actionId=" + getActionId() + "){"
          + "image=" + getImage()
