...
public class FavouriteMovieFragmentDirections {
  ...
  @NonNull
  public static ActionFavouriteMovieFragmentToMovieDetailsFragment actionFavouriteMovieFragmentToMovieDetailsFragment(
      @NonNull String image, @NonNull String backdrop, @NonNull String title,
      @NonNull String description, float rating, int id) {
    return new ActionFavouriteMovieFragmentToMovieDetailsFragment(image, backdrop, title, description, rating, id);
  }

  public static class ActionFavouriteMovieFragmentToMovieDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFavouriteMovieFragmentToMovieDetailsFragment(@NonNull String image,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setImage(@NonNull String image) {
      if (image == null) {
        throw new IllegalArgumentException("Argument \"image\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("image", image);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setBackdrop(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setTitle(@NonNull String title) {
      if (title == null) {
        throw new IllegalArgumentException("Argument \"title\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("title", title);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setDescription(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setRating(float rating) {
      this.arguments.put("rating", rating);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavouriteMovieFragmentToMovieDetailsFragment setId(int id) {
      this.arguments.put("id", id);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_favouriteMovieFragment_to_movieDetailsFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFavouriteMovieFragmentToMovieDetailsFragment that = (ActionFavouriteMovieFragmentToMovieDetailsFragment) object;
    ...
    public String toString() {
      return "ActionFavouriteMovieFragmentToMovieDetailsFragment(actionId=" + getActionId() + "){"
          + "image=" + getImage()
